...
appointments = Appointment.create([{description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 15.day).strftime("%d-%m-%Y")  +'10:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status2,appointment_type_id:app_type1},
