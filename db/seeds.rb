...
{description:'Sessao que permite ao paciente desenvolver a sua capacidade de atencao',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +' 14:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type1},
...
{description:'Sessao que permite ao paciente desenvolver as suas capacidades motoras',appointment_day:' '+(Date.today - 15.day).strftime("%d-%m-%Y")  +' 10:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status2,appointment_type_id:app_type1},
...
{description:'Sessao que permite ao paciente desenvolver a sua capacidade de atencao',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +' 15:30:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status2,appointment_type_id:app_type1},     
...
{description:'Sessao que permite ao paciente desenvolver a sua capacidade de flexibilidade mental',appointment_day:' '+(Date.today - 2.day - 1.month ).strftime("%d-%m-%Y")  +' 11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type1},
{description:'Sessao que permite ao paciente desenvolver as suas capacidades motoras',appointment_day:' '+(Date.today - 5.day).strftime("%d-%m-%Y")  +' 11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type1},
...
{description:'Sessao que permite ao paciente desenvolver as suas capacidades cognitivas visuo-espaciais e de construcao.',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +' 10:00:00',patient_id:patient7,secretary_id:secretary3,neuropsychologist_id:neuro4,appointment_status_id:app_status2,appointment_type_id:app_type1},    # clinica 2
...
{description:'Sessao que permite ao paciente desenvolver as suas capacidades motoras',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +' 10:00:00',patient_id:patient11,secretary_id:secretary4,neuropsychologist_id:neuro6,appointment_status_id:app_status2,appointment_type_id:app_type1},     # clinica 3
...
{description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +' 10:00:00',patient_id:patient13,secretary_id:secretary5,neuropsychologist_id:neuro7,appointment_status_id:app_status2,appointment_type_id:app_type1},     #clinica 4
