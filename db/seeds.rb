...
neuropsychologists = Neuropsychologist.create([{name:'Mario Rodrigues Simoes', address:'Rua das Fontainhas, Coimbra', telephone:'223421566', mobilephone:'923214007', date_of_birth:'09/12/1960', identification_code:'981324214', gender_id: male, clinic_id: clinic1, login_id: login1},
                                               ...
                                               {name:'Paulos Santos Matos', address:'Rua Dr Joaquim Pedrosa, Lisboa', telephone:'214578963', mobilephone:'965114785', date_of_birth:'15/10/1986', identification_code:'125487539', gender_id: male, clinic_id: clinic1, login_id: login3},
                                               {name:'Fabio Samuel Coelho da Silva', address:'Rua Tomas Pimenta, Porto', telephone:'224224252', mobilephone:'913264006', date_of_birth:'04/07/1980', identification_code:'548756951', gender_id: male, clinic_id: clinic2, login_id: login10},
...
appointments = Appointment.create([{description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +'09:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                    {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 2.day).strftime("%d-%m-%Y")  +'14:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type2},
                                    {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 2.day).strftime("%d-%m-%Y")  +'15:00:00',patient_id:patient2,secretary_id:secretary2,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                    {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today).strftime("%d-%m-%Y")  +'10:30:00',patient_id:patient2,secretary_id:secretary2,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type2},
                                    {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 1.day).strftime("%d-%m-%Y")  +'11:00:00',patient_id:patient2,secretary_id:secretary2,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                    ...
                                    {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 2.day).strftime("%d-%m-%Y")  +'09:30:00',patient_id:patient3,secretary_id:secretary2,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 15.day).strftime("%d-%m-%Y")  +'10:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades motoras',appointment_day:' '+(Date.today - 9.day).strftime("%d-%m-%Y")  +'12:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status2,appointment_type_id:app_type2},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 8.day).strftime("%d-%m-%Y")  +'09:30:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status2,appointment_type_id:app_type2},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidade de atencao',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +'15:30:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status2,appointment_type_id:app_type1},     
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidade de flexibilidade mental',appointment_day:' '+(Date.today + 1.day).strftime("%d-%m-%Y")  +'16:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status1,appointment_type_id:app_type2},
                                  ...
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidade de atencao',appointment_day:' '+(Date.today + 12.day).strftime("%d-%m-%Y")  +'11:00:00',patient_id:patient1,secretary_id:secretary1,neuropsychologist_id:neuro1,appointment_status_id:app_status1,appointment_type_id:app_type2},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 15.day).strftime("%d-%m-%Y")  +'10:30:00',patient_id:patient2,secretary_id:secretary1,neuropsychologist_id:neuro2,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades cognitivas visuo-espaciais e de construcao.',appointment_day:' '+(Date.today - 13.day).strftime("%d-%m-%Y")  +'10:00:00',patient_id:patient2,secretary_id:secretary2,neuropsychologist_id:neuro2,appointment_status_id:app_status2,appointment_type_id:app_type2},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 9.day).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient2,secretary_id:secretary3,neuropsychologist_id:neuro2,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades motoras',appointment_day:' '+(Date.today - 5.day).strftime("%d-%m-%Y")  +'10:00:00',patient_id:patient2,secretary_id:secretary2,neuropsychologist_id:neuro2,appointment_status_id:app_status2,appointment_type_id:app_type2},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades cognitivas visuo-espaciais e de construcao.',appointment_day:' '+(Date.today - 1.day).strftime("%d-%m-%Y")  +'09:00:00',patient_id:patient2,secretary_id:secretary1,neuropsychologist_id:neuro2,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                  ...
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 2.day - 1.month ).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today - 5.day).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status2,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 1.day + 1.week).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  ...
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 0.day + 2.week).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 1.month).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 3.month).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient5,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  ...
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 3.month).strftime("%d-%m-%Y")  +'09:30:00',patient_id:patient5,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 3.month).strftime("%d-%m-%Y")  +'17:30:00',patient_id:patient5,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 4.month).strftime("%d-%m-%Y")  +'16:30:00',patient_id:patient4,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type2},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 5.month).strftime("%d-%m-%Y")  +'14:30:00',patient_id:patient4,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 3.month).strftime("%d-%m-%Y")  +'15:00:00',patient_id:patient5,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type2},
                                  ...
                                  {description:'Sessao que permite ao paciente desenvolver as suas capacidades visuais',appointment_day:' '+(Date.today + 3.month).strftime("%d-%m-%Y")  +'11:30:00',patient_id:patient3,secretary_id:secretary1,neuropsychologist_id:neuro3,appointment_status_id:app_status1,appointment_type_id:app_type1},
...
testes = EvaluationTest.create([{name:'ftt',description:'intuito de medir a velocididade motora',test_area_id: areas.first.id},{name:'tmt',description:'Intuito de medir a atencao, a fexibilidade mental, a procura visual e a funcao motora',test_area_id: areas.first.id},{name:'wais',description:'medir a velocidade de processamento',test_area_id:areas.first.id},{name:'wms',description:'Intuito de avaliar a memoria de trabalho do paciente',test_area_id:areas.second.id},{name:'clock',description:'Permite avaliar as capacidades cognitivas visuo-espaciais e de construcao.',test_area_id:areas.second.id},])
