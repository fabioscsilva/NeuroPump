...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { email: @manager.email, mobilephone: @manager.mobilephone, password: @manager.password, telephone: @manager.telephone }
    end
  ...
  test "should update manager" do
    put :update, id: @manager, manager: { email: @manager.email, mobilephone: @manager.mobilephone, password: @manager.password, telephone: @manager.telephone }
    assert_redirected_to manager_path(assigns(:manager))
  end
