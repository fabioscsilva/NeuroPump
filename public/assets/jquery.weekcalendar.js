...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
       ...
       options : {
         ...
         longMonths : ['Janeiro', 'Fevereiro', 'Maço', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'],
      ...
      goToDate : function() {
         ...
         var diaAIr = globalev.date;
         var diaAtual = this.element.data("startDate");
         
         var newDate = new Date();
         
         if( diaAIr.valueOf() > diaAtual.valueOf())
         {
             var tempo = (diaAIr.getTime() - this.element.data("startDate").getTime());
             
              newDate = new Date(this.element.data("startDate").getTime() + tempo + (tempo / (tempo/(3600 * 1000))));
         }
         else
         {
             var tempo2 = (this.element.data("startDate").getTime() - diaAIr.getTime());
             
             newDate = new Date(this.element.data("startDate").getTime() - tempo2 - (tempo2 / (tempo2/(3600 * 1000))));
         }
      ...
      */
      ...
      _renderCalendar : function() {
         ...
         if (options.buttons) {
            ...
            $calendarContainer.find(".wc-nav .wc-nextyear").click(function() {
               self.element.weekCalendar("nextYear");
               return false;
            });
